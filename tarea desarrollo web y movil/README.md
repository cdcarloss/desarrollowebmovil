...
- Fondo decorativo: una animación de puntos y líneas verdes en `static/biblioteca/js/fondo.js`, dibujada en un `<canvas>` detrás del contenido. Se desactiva sola si el sistema tiene activado "reducir movimiento".
