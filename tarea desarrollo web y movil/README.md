...
- Fondo decorativo: franjas laterales sólidas (`#4c546b`) definidas por CSS puro en `styles.css` (sin JS ni video, para no afectar el rendimiento), que solo se asoman como marco angosto a los costados del contenido. El centro, donde está el texto, se mantiene sobre el color de página normal. Se ocultan en pantallas angostas.
